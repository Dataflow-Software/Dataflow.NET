...
namespace Dataflow.Tests
{
    ...
    public class NCachedTests
    {
        ...
        private readonly IChannel _target;
        ...
        public void SetUp()
        {
            _client = new CachedClient(_target, false);
            _foo = GetBytes("foo");
        }
        ...
        */
        ...
        public void KeyExpirationTest()
        {
            ...
            var lc = _target as LocalCache;
            if (lc != null) lc.UpdateUptime();
        ...
        public void TestSimpleAndBatchedCalls()
        {
            ...
            try
            {
                ...
                //var batch = new CachedClient.Batch();
                ...
                //Assert.IsTrue( batch.Responses[6].Status == 1, "get after delete" );
                //Assert.AreEqual( "ooops", batch.Responses[4].Text, "get after change" );
            }
            finally
            {
                //if( queue != null ) queue.Pipeline = 0;
